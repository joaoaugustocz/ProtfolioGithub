...
img: assets/img/projects/prognos/hero.svg
importance: 1
---
...
<div class="project-story-grid">
  ...
  <div class="project-story-visual">
    {% include project-media-panel.liquid
      path="assets/img/projects/prognos/hero.svg"
...
<div class="project-story-grid">
  ...
  <div class="project-story-visual">
    {% include project-media-panel.liquid
      path="assets/img/projects/prognos/hospital-context.svg"
      alt="Placeholder de contexto hospitalar do Prognos"
      caption="Slot reservado para imagem do robo em ambiente hospitalar."
      zoomable=true
    %}
  </div>
</div>
...
<div class="project-gallery">
  ...
  {% include project-media-panel.liquid
    ...
    caption="Arquitetura e modularizacao via ROS."
    compact=true
    zoomable=true
  %}
  {% include project-media-panel.liquid
    path="assets/img/projects/prognos/sensor-stack.svg"
  ...
  {% include project-media-panel.liquid
    path="assets/img/projects/prognos/hospital-context.svg"
    alt="Contexto hospitalar do Prognos"
    caption="Contexto de uso em ambiente interno sensivel."
    compact=true
    zoomable=true
  %}
</div>
...
{% include project-video-panel.liquid
  ...
  asset_hint="assets/video/projects/prognos/overview.mp4"
